                ...
                <div class="row">
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                <label class="control-label">Project Lists</label>
                            ...
                            <div class="form-group">
                                <label class="control-label">Webentry Lists</label>
                                <select class="form-control">
                                    <option value="">[Please Select]</option>
                                </select>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="http://202.90.158.88:8089/sysprocessmaker/en/neoclassic/14146050559758d5f5f53a5040410556/95587132459758d88a54176059963367.php"></iframe>
                        </div>
                    </div>
                </div>
            </div>
